...
## Corpus Check
- 28 files · ~92,929 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 980 nodes · 1854 edges · 73 communities (41 shown, 32 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 221 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5b51d3e3`
...
### Community 2 - "app.js"
Cohesion: 0.05
Nodes (41): abrirLoginOLogout(), abrirOpcionesPDF(), abrirPanelVariantes(), abrirWizardCarpetas(), actualizarBotonSesion(), aplicarTema(), cachePokemon, calcularJalon() (+33 more)
...
- **Why does `A()` connect `A` to `worker.min.js`, `K`, `tesseract-core-simd-lstm.wasm.js`, `Q`, `J`, `di`, `d`, `Lh`, `p`, `ji`, `kb`, `qb`?**
