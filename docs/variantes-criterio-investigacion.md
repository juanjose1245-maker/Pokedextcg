...
| Enamorus (Therian Forme) | 905 | Re-investigado bajo el criterio de arte distinto en la Tarea 13b (cierra el hueco dejado por la Tarea 13). Las 6 cartas impresas ("Enamorus V" swsh11-82/178/TG18, "Enamorus" swsh12pt5-67, sv6-93/180) muestran consistentemente Incarnate Forme (figura humanoide, brazos con manos/puños, pose erguida) — mismo patrón que Landorus/Thundurus/Tornadus. Ninguna muestra Therian Forme (forma aviar, sin brazos). |
...
- Esta lista es un primer paso, revisable, y no exhaustiva. Investigaciones futuras pueden agregar nuevos candidatos confirmados o descartados sin necesidad de rehacer lo ya documentado aquí. Caso concreto pendiente de revisión: Genesect/Silvally (investigados y no confirmados por ahora, pero el mismo bloqueo estructural de PokeAPI que afecta a Arceus/Cherrim aplicaría si en el futuro se encuentra evidencia visual más sólida).
