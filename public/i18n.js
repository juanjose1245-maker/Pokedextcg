...
const I18N = {
    es: {
        ...
        'error.generico': `Ocurrió un error inesperado.`,
        'error.requiere_sesion': `Necesitas iniciar sesión para hacer cambios.`,
        'error.rate_limit': `Demasiadas solicitudes seguidas, espera un momento.`,
        'error.password_ya_configurada': `Ya hay una contraseña configurada.`,
        'error.password_muy_corta': `La contraseña debe tener al menos 4 caracteres.`,
        'error.carpeta_no_seleccionada': `No se seleccionó ninguna carpeta válida`,
        'error.pdf_generacion_fallo': `No se pudo generar el PDF.`,
        'error.modo_invalido': `modo debe ser "bulk" o "carpetas"`,
        'error.id_invalido': `id de Pokémon inválido`,
        'error.carpetas_config_invalida_seguidas': `Configuración inválida: cada carpeta necesita nombre único, color (#rrggbb) y un rango de nº de Pokédex — y los rangos deben cubrir del 1 al 1025 sin huecos ni superposición.`,
        'error.carpetas_config_invalida_separadas': `Configuración inválida: cada carpeta necesita nombre único, color (#rrggbb), al menos una generación, y espacios suficientes para todos sus Pokémon — y las 9 generaciones deben repartirse sin faltar ni repetirse.`,
        'error.variantes_config_invalida': `Configuración de variantes inválida.`,
        'error.formato_archivo_invalido': `Formato de archivo inválido: falta la lista de registros.`,
        'error.respaldo_no_existe': `Ese respaldo no existe.`,
        'error.respaldo_corrupto': `El archivo de respaldo está corrupto.`,
        'error.deploy_no_configurado': `Auto-deploy no configurado`,
        'error.firma_invalida': `Firma inválida`,
    ...
    en: {
        ...
        'error.requiere_sesion': `You need to log in to make changes.`,
        'error.rate_limit': `Too many requests in a row, wait a moment.`,
        'error.password_ya_configurada': `A password is already set.`,
        'error.password_muy_corta': `Password must be at least 4 characters.`,
        'error.carpeta_no_seleccionada': `No valid folder was selected`,
        'error.pdf_generacion_fallo': `Couldn't generate the PDF.`,
        'error.modo_invalido': `mode must be "bulk" or "carpetas"`,
        'error.id_invalido': `Invalid Pokémon id`,
        'error.carpetas_config_invalida_seguidas': `Invalid configuration: each folder needs a unique name, a color (#rrggbb), and a Pokédex number range — and the ranges must cover 1 through 1025 with no gaps or overlaps.`,
        'error.carpetas_config_invalida_separadas': `Invalid configuration: each folder needs a unique name, a color (#rrggbb), at least one generation, and enough slots for all its Pokémon — and the 9 generations must be split up with none missing or repeated.`,
        'error.variantes_config_invalida': `Invalid variants configuration.`,
        'error.formato_archivo_invalido': `Invalid file format: missing the records list.`,
        'error.respaldo_no_existe': `That backup doesn't exist.`,
        'error.respaldo_corrupto': `The backup file is corrupted.`,
        'error.deploy_no_configurado': `Auto-deploy not configured`,
        'error.firma_invalida': `Invalid signature`,
